...
public class ResidentialBuilding implements Rescuable, Simulatable 
{
	...
	public String toString(){
		String s ="";
		s+=("Address: (" + location.getX() + "," + location.getY() + ")" + "\n");
		if(disaster == null)
			s+=("No Disaster on this Building." + "\n");
		else
			s+=("Disaster: " +disaster.getClass()  + "\n");
		s+=("Structural Integrity: " + structuralIntegrity + "\n");
		s+=("Foundation Damage: " + foundationDamage + "\n");
		s+=("Fire Damage: " + fireDamage + "\n");
		s+=("Gas Level: " + gasLevel + "\n");
		s+=("Number of Occupants: " +  occupants.size() + "\n");
